        ...
        <div class="content-wrapper">
                ...
                <div class="col-md-12 grid-margin">
                    <div class="row">
                        <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                            <h3 class="font-weight-bold">Welcome {{ $user->full_name}}{{ "($user->user)" }}</h3>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card tale-bg">
                        <div class="panel text-dark">
                            <div class="row my-2 mx-1">
                                <div class="col-4">
                                    Queue : 1018_Rajmandir_Test
                                </div>
                                <div class="col-3">
                                    Cust Num : 918528568452
                                </div>
                                <div class="" id="wraptime" hidden="">
                                    10
                                </div>
                                <div class="col-3">
                                    Agent : 8528568452
                                ...
                                <div class="col-2">
                                    Call Time:<span id="callduration">0:47</span>
                                </div>
                                <span id="cId" hidden="">
                                    1712555436.76
                                </span>
            ...
            <div class="row">
                <div class="col-md-6 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-wrap d-flex justify-content-between mb-5">
                                <div class="mt-1">
                                    <p class="text-muted">Last Login</p>
                                    <h3 class="text-primary fs-30 font-weight-medium">12.3k</h3>
                                </div>
                                <div class="mt-1">
                                    <p class="text-muted">Last Logout</p>
                                    <h3 class="text-primary fs-30 font-weight-medium">14k</h3>
                                </div>
                                <div class="mt-1">
                                    <p class="text-muted">Last Break</p>
